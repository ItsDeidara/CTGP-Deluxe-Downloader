...
(() => {
  ...
  var inspect = (v, opts = {}) => {
    ...
    const refs = opts.refs ?? /* @__PURE__ */ new Map();
...
${space}${p2},`).join("") + "\n";
  ...
  var URLSearchParams = class {
    constructor(init7) {
      let input = "";
      if (init7 && (typeof init7 === "string" || init7 instanceof URLSearchParams)) {
        input = String(init7);
      }
      const p2 = $.urlSearchNew(input, arguments[1]);
      Object.setPrototypeOf(p2, URLSearchParams.prototype);
      if (!input) {
        if (Array.isArray(init7)) {
          for (const [k, v] of init7) {
            p2.append(k, v);
          }
        } else if (init7 && typeof init7 === "object") {
          for (const [k, v] of Object.entries(init7)) {
            p2.set(k, v);
          }
        }
      }
  ...
  def(URLSearchParams);
  var searchParams = /* @__PURE__ */ new WeakMap();
  var URL = class {
    /**
    ...
    get searchParams() {
      let p2 = searchParams.get(this);
      if (!p2) {
        p2 = new URLSearchParams(
          this.search,
          // @ts-expect-error internal argument
          this
        );
        searchParams.set(this, p2);
      }
      return p2;
    }
    /**
  ...
  var EventTarget = class {
    ...
    addEventListener(type, callback, options) {
      ...
      const self3 = this || globalThis;
      const cbs2 = getCbs(self3, type);
    ...
    dispatchEvent(event) {
      const self3 = this || globalThis;
      const cbs2 = getCbs(self3, event.type);
      event.target = event.currentTarget = self3;
      for (const cb of cbs2.slice()) {
        if (cb.options?.once) {
          self3.removeEventListener(event.type, cb.cb);
        }
...
`;
  ...
  var Application = class {
    ...
    static get self() {
      if (!self2) {
        ...
        self2 = $.nsAppNew(nro);
        Object.setPrototypeOf(self2, Application.prototype);
      }
      return self2;
    }
    /**
    ...
    static *[Symbol.iterator]() {
      ...
      let offset = 0;
      while (1) {
        const id2 = $.nsAppNext(offset++);
        if (!id2)
          break;
        const app = $.nsAppNew(id2);
        Object.setPrototypeOf(app, Application.prototype);
        yield app;
      }
    }
  ...
  var IRSensor = class extends Sensor {
    ...
    constructor(opts = {}) {
      ...
      const self3 = $.irsSensorNew(image, color);
      Object.setPrototypeOf(self3, IRSensor.prototype);
      _7.set(self3, {
        activated: false,
        timestamp: null,
        image,
     ...
     */
    get image() {
      return _7(this).image;
    }
    get activated() {
      return _7(this).activated;
    }
    get hasReading() {
      return _7(this).timestamp !== null;
    }
    get timestamp() {
      return _7(this).timestamp;
    }
    start() {
      const i = _7(this);
      if (!i.activated) {
    ...
    stop() {
      clearInterval(_7(this).interval);
      $.irsSensorStop(this);
    }
  };
  ...
  var Navigator = class {
    ...
    get userAgent() {
      if (!state.ua) {
        const { name, version: version2 } = Application.self;
        state.ua = `${name}/${version2} (Switch; en-us) nx.js/${$.version.nxjs}`;
      }
      return state.ua;
    }
    /**
  ...
  def(Navigator);
  var navigator = new Navigator(INTERNAL_SYMBOL);
